...
pygame.display.set_caption("-FriendSheep-")

BG = pygame.image.load("graphics/menubackground.png")
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(100).render("FriendSheep", True, "#FFFFFF")
        ...
        OPTIONS_BUTTON = Button(image=pygame.image.load("graphics/Options Rect.png"), pos=(640, 400),
                                text_input="INSTRUCTION", font=get_font(55), base_color="#d7fcd4", hovering_color="White")
